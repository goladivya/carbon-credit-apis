const form = document.getElementById("inputForm");
    ...
    <p><strong>Source:</strong> Based on average electricity consumption assumptions from project standards (IPCC and national datasets).</p>`,
      thermal: `<p><strong>Fuel Amount:</strong> Enter amount of fuel from (coal(kg), natural_gas(m3) and diesel(l)) used</p>`,
      ...
      transportation: `<p><strong>Fuel Used:</strong> Enter total fuel consumption in liters and select the vehicle type</p>`
    };
    ...
    const fieldTemplates = {
      ...
      transportation: [
        { name: "vehicleType", type: "select", label: "Vehicle Type", options: ["car", "bus", "truck"] },
